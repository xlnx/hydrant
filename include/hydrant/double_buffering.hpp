...
VM_EXPORT
{
	...
	public:
		virtual void render( Image<cufx::StdByte3Pixel> &frame_out, int frame_idx ) = 0;

		virtual void display( Image<cufx::StdByte3Pixel> &frame_in, int frame_idx ) = 0;
	...
	{
		using FnType = std::function<void( Image<cufx::StdByte3Pixel> &, int )>;
	...
	public:
		void render( Image<cufx::StdByte3Pixel> &frame_out, int frame_idx ) override
		{
			render_fn( frame_out, frame_idx );
		}

		void display( Image<cufx::StdByte3Pixel> &frame_in, int frame_idx ) override
		{
